...
public:
    ...
    int start();
    // Метод сигнала
    void signalInputLine(string& payload);
...
private:
    enum OperationType { Input, SetSafeDimentions, SetBoxKeys, StopSystem, SelectBox, ApplyClientKey, ApplyBankKey, CloseBox, Cancel, ShowTree, Reset, Recover };
